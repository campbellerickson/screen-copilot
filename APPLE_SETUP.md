...
5. Select **"App"**
6. Fill in:
   - **Description:** Screen Time Budget
   - **Bundle ID:** `com.campbell.ScreenTimeBudget` (use reverse domain notation)
...
3. Click **"Continue"**
4. Fill in:
   - **Description:** Screen Time Budget Backend
   - **Identifier:** `com.campbell.ScreenTimeBudget.backend` (or your preferred ID)
5. Click **"Continue"** then **"Register"**
6. **Edit** the Services ID
7. Check **"Sign In with Apple"**
8. Click **"Configure"**
9. **Primary App ID:** Select your App ID (`com.campbell.ScreenTimeBudget`)
10. **Website URLs:**
...
3. **Key Name:** Screen Time Budget Apple Sign In
...
4. Fill in:
   ...
   - **Bundle ID:** Select your App ID (`com.campbell.ScreenTimeBudget`)
...
4. **Name:** Screen Time Budget Receipt Validation
5. Click **"Generate"**
...
- ✅ **Services ID:** `com.campbell.ScreenTimeBudget.backend`
...
4. Add each variable (Production environment):
   ...
   |-----|-------|-------------|
   | `APPLE_BUNDLE_ID` | `com.campbell.ScreenTimeBudget` | Production |
   | `APPLE_CLIENT_ID` | `com.campbell.ScreenTimeBudget.backend` | Production |
...
3. Value: `com.campbell.ScreenTimeBudget.backend`
...
- ✅ Verify Product ID matches exactly: `com.campbell.ScreenTimeBudget.premium.monthly`
